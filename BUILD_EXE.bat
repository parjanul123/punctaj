...
if !ERRORLEVEL! neq 0 (
    ...
    if !ERRORLEVEL! neq 0 (
        ...
        echo.
        echo To build EXE, you need Python installed.
...
echo.
echo To run:
echo   1. Double-click: %DIST_DIR%\exe_output\PunctajManager.exe
echo   2. Or from command line:
echo      cd %DIST_DIR%\exe_output
echo      PunctajManager.exe
echo.
echo Configuration files needed:
echo   - discord_config.ini (in same folder as EXE)
echo   - supabase_config.ini (in same folder as EXE)
echo.
