@echo off
REM ============================================================
REM PUNCTAJ MANAGER v2.5 - INSTALLER WITH AUTO-REFRESH
REM ============================================================
...
if exist "%SCRIPT_DIR%GRANULAR_PERMISSIONS_GUIDE.md" (
    copy "%SCRIPT_DIR%GRANULAR_PERMISSIONS_GUIDE.md" "%INSTALL_PATH%\" >nul 2>&1
    echo   ✓ GRANULAR_PERMISSIONS_GUIDE.md
)
if exist "%SCRIPT_DIR%QUICK_PERMISSIONS_REFERENCE.md" (
    copy "%SCRIPT_DIR%QUICK_PERMISSIONS_REFERENCE.md" "%INSTALL_PATH%\" >nul 2>&1
    echo   ✓ QUICK_PERMISSIONS_REFERENCE.md
)
...
echo.
echo NOUTATI v2.5:
echo   ✓ Permisiuni granulare pe institutii (add/edit/delete)
echo   ✓ Permisiuni pentru adaugare punctaj
echo   ✓ Auto-refresh dupa download din cloud
echo   ✓ Verifica permisiuni pentru fiecare buton
echo.
echo Pentru a lansa:
